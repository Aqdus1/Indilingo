...
conn=mysql.connector.connect(host="localhost",user="root", password="", database="hit")
cursor=conn.cursor()
...
@app.route('/hindi_levels')
def hindi_levels():
     if 'user_id' in session:
          return render_template('hindi_levels.html')
     else:
          return redirect('/')                   

@app.route('/urdu_levels')
def urdu_levels():
     if 'user_id' in session:
          return render_template('urdu_levels.html')
     else:
          return redirect('/') 

@app.route('/bengali_levels')
def bengali_levels():
     if 'user_id' in session:
          return render_template('bengali_levels.html')
     else:
          return redirect('/') 
...
@app.route('/kannada_levels')
def kannada_levels():
     if 'user_id' in session:
          return render_template('kannada_levels.html')
     else:
          return redirect('/') 

@app.route('/malayalam_levels')
def malayalam_levels():
     if 'user_id' in session:
          return render_template('malayalam_levels.html')
     else:
          return redirect('/') 
...
def telugu_levels():
     if 'user_id' in session:
          return render_template('telugu_levels.html')
     else:
          return redirect('/') 
